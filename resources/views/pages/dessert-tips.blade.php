...
@section('title', 'نصائح عمل الحلويات - موقع وصفة')
...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="container mx-auto px-4">
        ...
        <div class="bg-gradient-to-r from-orange-500 to-orange-600 rounded-2xl text-white p-12 mb-12 text-center">
            <h1 class="text-4xl md:text-5xl font-bold mb-6">نصائح عمل الحلويات</h1>
            <p class="text-xl md:text-2xl opacity-90 max-w-3xl mx-auto">
                نصائح وإرشادات من الخبراء لتحضير أجمل وألذ الحلويات
            </p>
        </div>
