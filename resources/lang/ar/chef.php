    ...
    'dashboard' => [
        'workshops' => [
            ...
            'host_room' => [
                ...
                'recording' => [
                    'label' => 'أدوات التسجيل',
                    'description' => 'بعد انتهاء الجلسة اضغط على زر المزامنة لجلب تسجيل Google Drive ومشاركته مع المشاركين.',
                    'sync' => 'مزامنة رابط التسجيل',
                    'syncing' => 'جاري المزامنة...',
                    'status_ready' => 'تم حفظ رابط التسجيل وسيظهر على صفحة الورشة العامة.',
                    'status_missing' => 'لم يتم العثور على التسجيل بعد. حاول مرة أخرى بعد بضع دقائق من إغلاق الغرفة.',
                    'status_error' => 'تعذر مزامنة التسجيل. يمكنك إضافة الرابط يدوياً إذا كان جاهزاً.',
                    'current_label' => 'رابط التسجيل الحالي',
                    'missing_label' => 'لم يتم إضافة رابط تسجيل حتى الآن.',
                    'disabled_hint' => 'خدمة المزامنة متوقفة مؤقتاً. بإمكانك لصق رابط Google Drive من صفحة تعديل الورشة.',
                    'messages' => [
                        'synced' => 'تمت مزامنة رابط التسجيل بنجاح.',
                        'already_synced' => 'رابط التسجيل محفوظ بالفعل.',
                        'not_found' => 'لم نعثر على التسجيل بعد. حاول مرة أخرى لاحقاً.',
                        'disabled' => 'مزامنة التسجيل غير متاحة حالياً.',
                        'missing_code' => 'تعذر التعرف على كود Google Meet الخاص بهذه الورشة.',
                        'offline' => 'تتوفر خاصية التسجيل فقط للورش الأونلاين.',
                    ],
                ],
                'participants' => [
    ...
    'workshop_form' => [
        ...
        'sections' => [
            ...
            'delivery' => [
                ...
                'highlight' => 'نوفر لك توليد رابط اجتماع Google Meet تلقائياً',
            ],
            'host' => [
                'eyebrow' => 'معلوماتك',
                'title' => 'تعريف بالمدرب',
