...
class RecipeController extends Controller
{
    ...
    private function validateRecipe(Request $request, ?int $recipeId = null): array
    {
        return $request->validate([
            ...
            'image_2' => ['nullable', 'image', 'mimes:jpeg,png,jpg,gif', 'max:4096'],
            'image_3' => ['nullable', 'image', 'mimes:jpeg,png,jpg,gif', 'max:4096'],
            'image_4' => ['nullable', 'image', 'mimes:jpeg,png,jpg,gif', 'max:4096'],
            'image_5' => ['nullable', 'image', 'mimes:jpeg,png,jpg,gif', 'max:4096'],
