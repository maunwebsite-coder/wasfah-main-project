...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="container mx-auto px-4 max-w-4xl">
        ...
        <div class="flex items-center justify-between mb-8">
            <div>
                <h1 class="text-3xl font-bold text-gray-800 mb-2">إضافة ورشة جديدة</h1>
                <p class="text-gray-600">أضف ورشة عمل جديدة للموقع</p>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-8">
            <form action="{{ route('admin.workshops.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <!-- Image -->
                    <div class="md:col-span-2">
                        <label for="image" class="block text-sm font-semibold text-gray-700 mb-2">صورة الورشة</label>
                        <input type="file" 
                               id="image" 
                               name="image" 
                               accept="image/*"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="featured_description" 
                                  ...
                                  placeholder="وصف خاص للورشة المميزة (اختياري)">{{ old('featured_description') }}</textarea>
                                    ...
                                    <div class="recipe-item bg-white rounded-lg border border-gray-200 p-4 hover:border-orange-300 transition-colors" 
                                        ...
                                        <label class="flex items-start cursor-pointer">
                                            <input type="checkbox" 
                                                   ...
                                                   {{ in_array($recipe->recipe_id, old('recipe_ids', [])) ? 'checked' : '' }}
                                            ...
                                            <div class="mr-3 flex-1">
                                                ...
                                                <div class="flex items-center justify-between text-xs text-gray-500">
                                                    <span><i class="fas fa-clock ml-1"></i> {{ $recipe->prep_time + $recipe->cook_time }} دقيقة</span>
                                                    <span><i class="fas fa-users ml-1"></i> {{ $recipe->servings }} حصة</span>
