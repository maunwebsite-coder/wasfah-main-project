...
@section('title', 'إضافة وصفة جديدة - منطقة الشيف')
    ...
    <div class="container mx-auto px-4">
        <div class="mb-6 flex flex-wrap items-center justify-between gap-4">
            <div>
                ...
                <h1 class="text-3xl font-bold text-gray-900">إضافة وصفة جديدة</h1>
                <p class="text-gray-600 mt-1">املأ التفاصيل التالية لإضافة وصفتك وإرسالها لفريق المراجعة.</p>
            </div>
